...
- [Library](#Library)
    ...
    - [Adding Globfuscation](#Adding-Globfuscation)
- [Report](#Report)
...
## Report
BYOL provides the option to export scan results in 2 formats: **Excel** and **JSON**. The **Breached Simulation Score** is calculated based on the following formula:
```
